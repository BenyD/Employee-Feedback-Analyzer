  ...
  try {
    ...
    const decryptedData = feedbackData.map((item: any) => {
      ...
      return {
        ...
        sentimentIntensity: item.sentiment_intensity,
        workEnvironmentSentiment: item.work_environment_sentiment,
        workEnvironmentSentimentLabel: item.work_environment_sentiment_label,
        workEnvironmentIntensity: item.work_environment_intensity,
        managementSentiment: item.management_sentiment,
        managementSentimentLabel: item.management_sentiment_label,
        managementIntensity: item.management_intensity,
        compensationSentiment: item.compensation_sentiment,
        compensationSentimentLabel: item.compensation_sentiment_label,
        compensationIntensity: item.compensation_intensity,
        growthOpportunitiesSentiment: item.growth_opportunities_sentiment,
        growthOpportunitiesSentimentLabel:
          item.growth_opportunities_sentiment_label,
        growthOpportunitiesIntensity: item.growth_opportunities_intensity,
